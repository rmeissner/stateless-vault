...
const Initializor = artifacts.require("./Initializor.sol")
const Factory = artifacts.require("./ProxyFactoryWithInitializor.sol")
...
contract('StatelessVault', function(accounts) {
    ...
    it('create with initializor and deposit and withdraw 1 ETH', async () => {
        ...
        const proxyCreationData = initializor.contract.methods.setValidators(deploymentValidators).encodeABI()
        const vaultAddress = await proxyFactory.createProxyWithNonce.call(initializor.address, proxyCreationData, 0)
        ...
        const setupHash = await initializor.generateSetupHashForAddress(
            vaultAddress,
